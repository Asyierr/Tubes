        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                <div class="text-center mb-6">
                    <h2 class="text-2xl font-bold text-white">Daftar sebagai Driver 🚚</h2>
                    <p class="text-slate-400 text-sm mt-2">Gabung dan mulailah mengantar!</p>
                </div>
                ...
                <form method="POST" action="{{ route('register.store') }}" class="space-y-6">
                    ...
                    <!-- Vehicle Number -->
                    <div>
                        <label class="block text-slate-300 text-sm font-medium mb-1">Nomor Kendaraan</label>
